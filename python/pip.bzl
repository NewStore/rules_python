...
def python(repository_ctx):
  if "BAZEL_PIP_PYTHON" in repository_ctx.os.environ:
    return repository_ctx.os.environ.get("BAZEL_PIP_PYTHON")
...
def _pip_import_impl(repository_ctx):
  ...
  result = repository_ctx.execute([
    python(repository_ctx), repository_ctx.path(repository_ctx.attr._script),
